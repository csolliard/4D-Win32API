...
#define  EX_CALL_SPELLER							-77		// unsupported
	// 78 hotlinks, obsolete							
#define  EX_GET_SPELLER_DATA						-79		// unsupported
...
#define  EX_GET_FIELD_RELATIONS						-131	// PA_GetFieldRelation
	// 132 reserved
#define  EX_CALC_PROCEDITOR_LINE					-133	// unsupported
	// 134 obsolete
...
#define  EX_GET_4D_SPELLER							-182	// PA_Get4DSpellerProcPtr
